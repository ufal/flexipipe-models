...
such as [SpaCy](https://spacy.io/), [UDPIPE](https://lindat.mff.cuni.cz/services/udpipe/), [NameTag](https://lindat.mff.cuni.cz/services/nametag/), [HuggingFace transformers](https://huggingface.co/docs/transformers/index), and [Stanza](https://stanfordnlp.github.io/stanza/). This repository provides two things: a central list of all the official models for those backends where they need one and do not provide one. And on the other hand, additional models
for those backends that were trained using flexipipe, or provided by the community at a publicly accessible repository. The models listed can of course also be used directly in the tools they belong to without the use of flexiPipe.
